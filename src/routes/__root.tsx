  ...
  head: () => ({
    meta: [
      ...
      { title: "CareerSetu — AI Career & Government Exam Guidance" },
      {
        name: "description",
        content:
          "AI career guidance, government exam finder and study planning for Indian students.",
      },
      { name: "author", content: "CareerSetu" },
      { property: "og:title", content: "CareerSetu — AI Career & Government Exam Guidance" },
      {
